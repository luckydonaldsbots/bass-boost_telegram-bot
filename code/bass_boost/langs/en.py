class Lang(object):
    ...
    capslock_number_1 = "ONE"
    capslock_number_11 = "ELEVEN"
    capslock_number_111 = "ONEHUNDREDANDELEVEN"
    caption_shit = lambda times: "!!!!111111!!112111!"[:times] + ("" if times < 20 else (Lang.capslock_number_1 if times < 21 else Lang.capslock_number_11) + "!11!1!111!1!!"[:times-21] + "".join(str(i-33) for i in range(34, times)))
